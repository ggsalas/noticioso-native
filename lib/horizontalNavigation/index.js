...
/*
    opacity: 0; 
    animation: fadeIn 20ms forwards;
...
export const script = `
  ...
  const pageNumber = viewportEl?.getAttribute('data-page-number') ?? 1;
  const scrollLeft = viewportWidth ? viewportWidth * (pageNumber - 1) : 0;
...
export function getHorizontalNavigationPage({
  content,
  width,
  theme,
  pageNumber,
  ...
  return `
    ...
    <main id="viewport" data-page-number="${pageNumber}" lang="es">
      <div id="article">
        ${content}
      </div>
    </main>
